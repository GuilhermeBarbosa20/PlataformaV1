...
def classify_director_intent(
    ...
    system_prompt = (
        ...
        "- daily_digest: utilizador pede análise do que funcionou/falhou (ontem, "
        "período recente), briefing, melhores dias/horas para publicar, ou "
        "progresso diário — só quando pede explicitamente no chat e com LinkedIn "
        "ligado + perfil analisado; se faltar sessão, o sistema pede para ligar.\n"
